module Ym4r
  module GmPlugin
    ...
    class ApiKey
      ...
      unless File.exist?(RAILS_ROOT + '/vendor/extensions/stores/config/gmaps_api_key.yml')
        raise GMapsAPIKeyConfigFileNotFoundException.new("File RAILS_ROOT/vendor/extensions/stores/config/gmaps_api_key.yml not found")
      else
        env = ENV['RAILS_ENV'] || RAILS_ENV
        GMAPS_API_KEY = YAML.load_file(RAILS_ROOT + '/vendor/extensions/stores/config/gmaps_api_key.yml')[env]
      end
